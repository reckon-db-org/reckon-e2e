...
| Adapter behavioural equivalence (mem-evoq vs reckon-evoq) | `adapter_swap_torture` | 📝 scoped |
...
`reckon-db` + `reckon-evoq` will be added when the multi-node and adapter-swap axes land.
